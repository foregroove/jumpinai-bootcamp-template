...
経費科目分類は `expense-categorize` スキル（`.claude/skills/expense-categorize/SKILL.md`）を参照すること。
...
| 2026/04/26 | v0.2 | §5-2 ハンズオンに合わせて経費科目の詳細ルールを expense-categorize スキルへ切り出し |
| 2026/04/26 | v0.3 | Python 言語表記を `3.11` 固定から `3.11+（3.12 / 3.13 / 3.14 も可）` に更新。3.14 で実機動作検証済み |
